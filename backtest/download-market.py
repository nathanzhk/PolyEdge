...
from backtest.backtest_rest import get_orderbook_by_slug
...
aggregate = importlib.import_module("interval-market").aggregate
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python download.py 2026-04-06")
        sys.exit(1)
    ...
    with ThreadPoolExecutor(max_workers=8) as pool:
        ...
        for future in as_completed(futures):
            ...
            print(f"  [{done}/{total}] {futures[future]}")
