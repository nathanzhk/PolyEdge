...
@deprecated("PositionLatestState is deprecated.", category=None)
...
@deprecated("MarketLatestState is deprecated.", category=None)
...
@deprecated("IndicatorLatestState is deprecated.", category=None)
@dataclass(slots=True, frozen=True)
